        ...
        <div className="bg-white border border-[var(--border-soft)] rounded-[var(--card-radius)] p-8 shadow-[var(--card-shadow)]">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-[var(--brand-primary)] hover:bg-[#3F38A4] text-white font-semibold rounded-2xl shadow-[0_4px_14px_rgba(79,70,186,0.25)] hover:shadow-[0_6px_20px_rgba(79,70,186,0.3)] transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
              {isLoading ? (
